...
MenuOpciones::MenuOpciones()
{
    ...
    this->cargarDatosVentana(3,al_load_bitmap("./images/13FondoOpciones.jpg"));//El primer dato int pide la cantidad de botones totales.

    //Cargar botones uno a uno:
    ALLEGRO_BITMAP *botonne;
    botonne = al_load_bitmap("./images/BotonSonidoOff.png");
    al_convert_mask_to_alpha(botonne, al_map_rgb(255, 0, 255));

    this->cargarBoton(1,400,90,500,190,botonne);
    this->cargarBoton(2,400,200,500,300,al_load_bitmap("./images/NivelDificultadInicio.png"));
    this->cargarBoton(3,400,500,570,560,al_load_bitmap("./images/VolverMenu.jpg"));
...
void MenuOpciones::dibujar(DatosMouse * dm)
{
    ...
    case 1:
        ...
        {
        case 0:
            this->getBoton(0)->setImagen(al_load_bitmap("./images/BotonSonidoOn.png"));
            flag1 = 1;
            break;

        case 1:

            this->getBoton(0)->setImagen(al_load_bitmap("./images/BotonSonidoOff.png"));
            flag1 = 0;
            break;
        }
        break;
    case 2:
        ...
        {
        case 0:
            this->getBoton(1)->setImagen(al_load_bitmap("./images/NivelDificultadFacil.png"));
            flag2 = 1;
            break;

        case 1:

            this->getBoton(1)->setImagen(al_load_bitmap("./images/NivelDificultadNormal.png"));
            flag2 = 2;
            break;
        case 2:

            this->getBoton(1)->setImagen(al_load_bitmap("./images/NivelDificultadDificil.png"));
            flag2 = 3;
            break;
        case 3:

            this->getBoton(1)->setImagen(al_load_bitmap("./images/NivelDificultadExperto.png"));
            flag2 = 0;
            break;
